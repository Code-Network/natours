...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoia29rb2RldiIsImEiOiJja2tjcGp3eXcwMnEyMnZvNWhiYmI2YzNnIn0.WP6FZ9ufCyuzw1L-utBMJQ';
  ...
  var bounds = new mapboxgl.LngLatBounds(); // Extend LatLngBounds with all the locations in our locations array
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // Add popup to display location
...
var stripe = Stripe('pk_test_wD5MlN7eIOjyjhwwUqzimlkC00plhdq1vC');
/*
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    e.preventDefault(); // Get email and password value the user puts in
...
if (logOutBtn) logOutBtn.addEventListener('click', _login.logout); // TODO:  Set an event listener to update name, email and photo from
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    var form = new FormData(); // Get email and password value the user puts in by appending key/value pairs
    ...
    form.append('photo', document.getElementById('photo').files[0]); // Axios will recognize const form as an object and work the same as before
